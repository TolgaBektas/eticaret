		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit"><?php echo $ayarcek['ayar_author'] ?><a href="http://tolgabektas.com"> www.tolgabektas.com</a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						...
						<a href="http://<?php echo $ayarcek['ayar_youtube'] ?>" class="fyoutube">Youtube</a>
						<a href="http://<?php echo $ayarcek['ayar_google'] ?>" class="fgoogle">Google</a>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				</div><!--footer Share-->

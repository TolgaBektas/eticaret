...
$say=$urunsor->rowCount();//burdakı sorgu her türlü çalışacak ve çalıştığında sorgu sağlanmaz ise sıfır değer dönecek
				...
				<div class="x_content">
					...
					<form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="urun_ad" required="" class="form-control col-md-7 col-xs-12" value="<?php echo $uruncek['urun_ad'] ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="urun_fiyat" required="" class="form-control col-md-7 col-xs-12" value="<?php echo $uruncek['urun_fiyat'] ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="urun_video" class="form-control col-md-7 col-xs-12" value="<?php echo $uruncek['urun_video'] ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="urun_keyword" required="" class="form-control col-md-7 col-xs-12" value="<?php echo $uruncek['urun_keyword'] ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="urun_stok" required="" class="form-control col-md-7 col-xs-12" value="<?php echo $uruncek['urun_stok'] ?>">
							</div>
						</div>
